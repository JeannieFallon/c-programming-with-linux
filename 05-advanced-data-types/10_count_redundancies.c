...
// count how many redundancies can be observed in the number stored in this list and 
// return this count of redundancies. A redundancy is a digit which has previously 
// already occurred in the number. For example, in the number 39534, the second '3' is 
// a redundancy.
